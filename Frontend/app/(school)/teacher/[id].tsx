...
import { Image, ScrollView, TouchableOpacity, View, StyleSheet, RefreshControl, ActivityIndicator } from 'react-native'
      ...
      <Card variant="elevated" style={styles.card}>
        <View style={styles.cardRow}>
          ...
          <View style={styles.cardInfo}>
            ...
            <Text variant="caption" color="textSecondary">{teacher.nationalId}</Text>
          </View>
        </View>
      </Card>
    </TouchableOpacity>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <Header
        ...
        onBack={() => router.back()}
        rightElement={
          <TouchableOpacity style={styles.addBtn} onPress={() => router.push('/(school)/add-teacher')} activeOpacity={0.8}>
